 ...
 * $Id$
 *
 * Spaf/tests/Unit/Library/Directory/DirectoryTest.php
...
/**
 * \Spaf\tests\Unit\Library\Directory\DirectoryTest
 *
 ...
 * @namespace Spaf\tests\Unit\Library\Directory
 */
class DirectoryTest extends \Spaf\tests\Unit\TestCase {
	...
	public function testGetChildrenMocked() {
		...
		$this->_directory->setDirectoryClass('\Spaf\tests\Mock\Library\Directory\Directory');
		$this->_directory->setFileClass('\Spaf\tests\Mock\Library\Directory\File');
		...
		foreach ($directoryContent as $content) {
			$this->assertTrue(
				get_class($content) === 'Spaf\tests\Mock\Library\Directory\Directory' ||
				get_class($content) === 'Spaf\tests\Mock\Library\Directory\File'
			);
		}
