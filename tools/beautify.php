...
final class Beautify {
	...
	public function __construct() {
		...
		// chdir to root tools direcotry in any case
		chdir(__DIR__);

		// requiere test-autoloader environment
		require_once('autoloader.php');
		$loader = new \Spaf\tools\Autoloader();
		...
		foreach ($files as $file) {
			...
			try {
				...
				// thrown if try to save an empty file, we have some int our tests/Data folder
			}
		}
	}
}
