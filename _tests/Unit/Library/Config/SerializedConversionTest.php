 ...
 * $Id$
 *
 * Spaf/_tests/Unit/Library/Config/SerializedConversionTest.php
...
/**
 * \Spaf\_tests\Unit\Library\Config\SerializedConversionTest
 *
 * The SerializedConversionTest class tests any aspect of \Spaf\Library\Config\Driver\Serialized conversion.
 *
 * @author Claudio Walser
...
class SerializedConversionTest extends Conversion {
    ...
    protected function setUp() {
        parent::setUp();
        $this->_mainConfig->setSourceFile($this->_fileSrz);
